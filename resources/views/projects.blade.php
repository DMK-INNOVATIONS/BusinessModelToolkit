...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1 col-sm-10 col-xs-12">
			<div class="panel panel-default">
				<div class="panel-heading">My Assigned Projects <button type="button" data-toggle="modal" data-target="#assignedHelpModal" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span></button></div>
				<div class="panel-body">
					<div class="panel panel-default">
					  <div class="panel-body table_text">
							...
							foreach ($myAssignedProjects as $myAssignedProject){
								print '<div class="row table_body">';
									print '<div class="col-md-3">'.$myAssignedProject["title"].'</div>
							  		...
							  		<div class="col-md-3">'.$myAssignedProject["updated_at"].'</div>
									<div class="col-md-1"></div>
							  		<div class="col-md-2">';
									print '<a href="projects/showBMCs/'.$myAssignedProject["id"].'"><button type="button" class="btn btn-default">show BMC\'s </button></a>';
					    			print'</div>';
								print '</div>';							
							}
							?>   
...
<!-- Help Modal Assigned projects-->
<div class="modal fade" id="assignedHelpModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Assigned Projects</h4>
      </div>
      <div class="modal-body">
        ... Hier muss noch Text rein ...
      </div>
